...
void createPage(String featureName, String pageName) {
  ...
  File(p.join(
          controllerPath, '${convertToSnakeCase(pageName)}_controller.dart'))
      .writeAsStringSync(controllerTemplate(pageName));
  File(p.join(bindingPath,
          '${convertToSnakeCase(pageName)}_controller_binding.dart'))
